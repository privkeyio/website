...
| 3 | ops | One Sunbiz lookup to confirm active FL status and the registered agent. (Entity form is set to "Florida LLC"; this closes the confirmation.) |
...
| 6 | ops | Confirm the principal place of business is Tampa. Both documents and `index.html` JSON-LD say Tampa, and arbitration is seated in Hillsborough County. If the real PPB is elsewhere, all three change together |
